...
def run_test_pizza():
    ...
    window = rg.RoseWindow(400, 400, 'Test 4')
    circle = rg.Circle(rg.Point(200, 200), 150)
...
def run_test_polygon():
    ...
    window = rg.RoseWindow(400, 400, 'Test 3: black square on green circle')
...
def run_test_fancy_polygon():
    ...
    # Test 5:
    window = rg.RoseWindow(400, 400, 'Test 5')
    ...
    # Test 6:
    window = rg.RoseWindow(400, 400, 'Test 6')
    circle = rg.Circle(rg.Point(200, 200), 100)
    circle.fill_color = 'yellow'
